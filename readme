...
3- VARNAv3-93.jar should be in the working repository.
...
Parameters that should be set:
 ...
 -`numberofsruct`: number of strcutures generated for each condition, once the value is fixed a folder `OutputSamples{numberofsruct}` is created.
